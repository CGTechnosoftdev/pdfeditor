	...
	<div class="row">
		<div class="col-xs-8 col-md-8">
			...
			<div class="form-group {{ $errors->has('question') ? ' has-error' : '' }}">
				<label for="question" class="control-label col-sm-4 required">Question<span class="required-label">*</span></label>	
				<div class="col-sm-8">
			...
			<div class="form-group {{ $errors->has('answer') ? ' has-error' : '' }}">
				<label for="answer" class="control-label col-sm-4 required">Answer<span class="required-label">*</span></label>	
				<div class="col-sm-8">
