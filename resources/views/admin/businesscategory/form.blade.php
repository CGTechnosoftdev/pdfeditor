	...
	<div class="row">
		<div class="col-xs-8 col-md-8">
			...
			<div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
				<label for="name" class="control-label col-sm-4 required">Name<span class="required-label">*</span></label>	
				<div class="col-sm-8">
			...
			<div class="form-group {{ $errors->has('slug') ? ' has-error' : '' }}">
				<label for="slug" class="control-label col-sm-4 required">Slug<span class="required-label">*</span></label>
				<div class="col-sm-8" >
			...
			<div class="form-group {{ $errors->has('heading') ? ' has-error' : '' }}">
				<label for="heading" class="control-label col-sm-4 required">Heading<span class="required-label">*</span></label>
				<div class="col-sm-8" >
			...
			<div class="form-group {{ $errors->has('short_description') ? ' has-error' : '' }}">
				<label for="short_description" class="control-label col-sm-4 required">Short Description<span class="required-label">*</span></label>
				<div class="col-sm-8" >
			...
			<div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
				<label for="description" class="control-label col-sm-4 required">Description<span class="required-label">*</span></label>
				<div class="col-sm-8" >
