			...
			<div class="row">
				<div class="col-xs-12 col-lg-6 col-md-9">
					...
					<div class="form-group {{ $errors->has('feature_list') ? ' has-error' : '' }}">
						<label for="feature_list" class="control-label text-left col-sm-4 required">Feature List<span class="required-label">*</span></label>
						<div class="col-sm-8">
							{{ Form::textarea('feature_list',old('feature_list'),['placeholder'=>'Enter Feature List','class'=>"form-control ckeditor"])}}
