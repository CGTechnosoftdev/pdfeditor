...
$toggle_status = $button_data['toggle_status'] ?? true;
@endphp
<div class="dropdown dropdown-inline">
	...
	@php ($checked_status = "")
	@endif
	@if(!empty($toggle_status) && isset($checked_status) && (empty($button_data['permission']) || auth()->user()->can($button_data['permission'])))
