...
<section class="content">
	...
	<div class="box">
		<div class="box-body">
			<div class="row">
				@if(isset($user))
				{{ Form::model($user,['route' => ['user.update',$user->id],'class'=>'form-horizontal','method'=>'put','enctype'=>"multipart/form-data"]) }}
				@else
				{{ Form::open(['route' => 'user.store','method'=>'post','class'=>'form-horizontal','enctype'=>"multipart/form-data"]) }}
				@endif
				{!! Form::token() !!}
				<div class="col-xs-12 col-lg-6 col-md-9">
					...
					<div class="form-group">
						<div class="col-sm-offset-4 col-sm-8">
							...
							{!! Html::link(route('user.index'),'Cancel',['class'=>'btn btn-default']) !!}
						</div>
					</div>
				</div>
				<!-- /.row -->
...
{!! JsValidator::formRequest('App\Http\Requests\UserFormRequest') !!}
@endsection