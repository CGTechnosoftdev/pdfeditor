					...
					<div class="addnew-body">
						...
						<div class="shareable-links">
							<ul>
								<li>
									<a href="#">
										<div class="link-img"><img src="../public/front/images/upload.svg"></div>
										<span>Upload Document</span>
									</a>
								</li>
								<li>
									<a href="#">
										<div class="link-img"><img src="../public/front/images/upload-template.svg"></div>
										<span>Upload Template</span>
									</a>
								</li>
								<li>
									<a href="#">
										<div class="link-img"><img src="../public/front/images/create-document.svg"></div>
										<span>Create Document</span>
									</a>
								</li>
								<li>
									<a href="#">
										<div class="link-img"><img src="../public/front/images/new-folder.svg"></div>
