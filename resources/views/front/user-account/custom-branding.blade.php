    ...
    <div class="row">
        <div class="col-md-6">
            <div class="genrate_custom_branding">
                ...
                {{ Form::model($custom_branding_model,['route' => ['front.custom-branding-save'],'method'=>'post','id'=>'profile-info-update-form','enctype'=>"multipart/form-data","autocomplete" => 'off']) }}
                @else
                {{ Form::open(['route' => ['front.custom-branding-save'],'method'=>'post','id'=>'profile-info-update-form','enctype'=>"multipart/form-data","autocomplete" => 'off']) }}
                @endif
                <div class="template-brand-info">
                    <h3>Company Logo</h3>
                ...
                <div class="personalize-invitation-content">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            {!! Form::submit('Save',['class'=>'btn btn-success addnew-btn','id'=>'cust_branding_save_btn']) !!}
                        </div>
        ...
        <div class="col-md-6">
            <div class="preview_custom_branding tabs-stage">
                        ...
                        <div class="brand-content">
                            ...
                            <div class="brand-footer">
                                <div id="signature_block">
                                    <div id="signature_firstname_view_{{$templateIndex}}"></div>
                                    <div id="signature_lastname_view_{{$templateIndex}}"></div>
                                    <div id="signature_title_view_{{$templateIndex}}"></div>
                                    <div id="signature_company_view_{{$templateIndex}}"></div>
                                    <div id="signature_email_view_{{$templateIndex}}"></div>
                                    <div id="signature_phone_view_{{$templateIndex}}"></div>
                                    <div id="signature_fax_view_{{$templateIndex}}"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {{ Form::open(['route' => ['front.custom-branding-test-email'],'method'=>'post','id'=>'send-test-email-form','enctype'=>"multipart/form-data","autocomplete" => 'off']) }}
                ...
                {!! Form::submit('Send Test Email',['class'=>'share-btn','id'=>'custom_branding_test_email_button']) !!}
                {{ Form::close() }}
...
{!! JsValidator::formRequest('App\Http\Requests\CustomBrandingFormRequest','#profile-info-update-form') !!}
<script>
    ...
    $('#first_name').keyup(delayTyping(function(e) {
        $("div[id ^= 'signature_firstname_view']").html($(this).val());
    }, 500));

    $('#last_name').keyup(delayTyping(function(e) {

        $("div[id ^= 'signature_lastname_view']").html($(this).val());

    }, 500));

    $('#title').keyup(delayTyping(function(e) {

        $("div[id ^= 'signature_title_view']").html($(this).val());

    }, 500));

    $('#company').keyup(delayTyping(function(e) {

        $("div[id ^= 'signature_company_view']").html($(this).val());

    }, 500));
    $('#email').keyup(delayTyping(function(e) {

        $("div[id ^= 'signature_email_view']").html($(this).val());

    }, 500));
    $('#phone').keyup(delayTyping(function(e) {

        $("div[id ^= 'signature_phone_view']").html($(this).val());

    }, 500));
    $('#fax').keyup(delayTyping(function(e) {

        $("div[id ^= 'signature_fax_view']").html($(this).val());
